...
function showDialog(event,content){
	alert(content);
}


function ExecuteApplication(path){
		Exec(te,path,'Exec',te.hwnd,null);
}

function ExecuteTools(command){
		Exec(te,command,'Tools',te.hwnd,null);
}
