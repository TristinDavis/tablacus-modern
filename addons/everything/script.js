...
if (window.Addon == 1) {
	...
	SetAddon(Addon_Id, Default, ['<input class="everything" type="text" name="everythingsearch" placeholder="search" onkeydown="return Addons.Everything.KeyDown(this)" onmouseup="Addons.Everything.Change(this)" onfocus="Addons.Everything.Focus(this)" onblur="Addons.Everything.ShowButton()" style="width:', EncodeSC(width), '; padding-right:', WINVER < 0x602 ? "32" : "16", 'px; vertical-align: middle"><span class="button" style="position: relative"><input type="image" id="ButtonEverythingClear" src="bitmap:ieframe.dll,545,13,1" onclick="Addons.Everything.Clear()" style="display: none; position: absolute; left: -33px; top: -5px" hidefocus="true"><input type="image" class="everything_icon" src="', EncodeSC(icon), '" onclick="Addons.Everything.Search()" hidefocus="true"></span>'], "middle");
} else {
